	...
	<div style="float: right">
		<table class="toolbar"><tr>
			<td class="button" id="toolbar-save">
				<a href="#" onclick="javascript: submitbutton('saveproduct')" class="toolbar">
				<span class="icon-32-save" title="<?php echo JText::_('SAVE'); ?>"></span><?php echo JText::_('SAVE'); ?></a>
			</td>
			<td class="divider"></td>
			<td class="button" id="toolbar-cancel">
				<a href="#" onclick="javascript: submitbutton('cancelproduct');" class="toolbar">
...
<form action="index.php" method="post" name="adminForm">
	...
	<legend><?php echo JText::_('PRODUCTS'); ?></legend>
		...
		<?php foreach($this->productlist as $tmp) : ?>
			<option value="<?php echo $tmp->product_id; ?>"><?php echo $tmp->product_name.' ('.$tmp->product_sku.')'; ?></option>
		<?php endforeach; ?>
		</select>
