...
<form action="<?php echo JRoute::_( 'index.php?option=com_awocoupon&view=coupon&layout=assets&tmpl=component' ); ?>" method="post" name="adminForm" id="adminForm">
	...
	<thead>
		<tr>
			...
			<th class="title"><?php echo JHTML::_('grid.sort', $this->coupon->function_type2=='product' ? 'COM_AWOCOUPON_CP_PRODUCT' : 'COM_AWOCOUPON_CP_CATEGORY', 'asset_name', $this->lists['order_Dir'], $this->lists['order'] ); ?></th>
		</tr>
	</thead>
	<tfoot>
